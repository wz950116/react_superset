        ...
        <div className="row">
          ...
          <div className="col-md-12 chart-controls">
            <div className="pull-right">
              <a title="Move chart" data-toggle="tooltips">
              ...
              <a href={slice.csv_url} className="download_csv" title="下载数据" data-toggle="tooltip" target="_blank" rel="noopener noreferrer">
