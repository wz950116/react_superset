...
import {
  addToObject, alterInObject, alterInArr, removeFromArr, getFromArr, addToArr,
}
  from '../reduxUtils';
...
export const sqlLabReducer = function (state, action) {
  const actionHandlers = {
    ...
    [actions.START_QUERY]() {
      ...
      newState.latestQueryId = action.query.id;
    ...
    [actions.SYNC_TIME]() {
      return Object.assign({}, state, { queriesLastUpdate: action.results.query.startDttm });
    },
    [actions.QUERY_SUCCESS]() {
      ...
      const alts = {
        endDttm: action.query.endDttm,
        startDttm: action.query.startDttm,
        progress: 100,
